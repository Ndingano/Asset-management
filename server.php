...
<body class="backImg">
  ...
  <nav class="navbar fixed-top navbar-white " id="navbar">
    <ul id="rect">
      ...
      <li>
        <a  class="active"  href="news.asp">ASSETS</a>
      </li>
      <li>
...
<?php
    ...
    $sql="SELECT * FROM `checking` WHERE Name='server'";
     ...
     while($row=$result->fetch_assoc()){
      ...
      <td>".$row["TowerBrandName"]."</td>
       ...
       <td>".$row["MonitorStatus"]."</td>
        ...
        <td>".$row["mouse"]."</td>
        <td>".$row["DonatedTo"]."</td>
        <td><button class=btn btn-info style='background-color: #009933;'>Update</button></td>
           <td><button style='background-color: #ff0000;' class=btn btn-warning>Delete</button></td>
          </tr>";
